...
class _TemperatureMonitoringState extends State<TemperatureMonitoring> {
  ...
  Widget _buildChart() {
    return Container(
      ...
      child: CustomPaint(
        painter: TemperatureChartPainter(data: _chartData),
      ...
      child: Column(
        ...
        children: [
          ...
          IntrinsicHeight(
            child: Row(
              children: [
                _buildReviewStat('Average', '35°C', const Color(0xFFE8622A)),
                VerticalDivider(color: Colors.grey.shade300, thickness: 1),
                _buildReviewStat('Lowest', '32°C', const Color(0xFF1B3A4B)),
                VerticalDivider(color: Colors.grey.shade300, thickness: 1),
                _buildReviewStat('Highest', '40°C', Colors.red),
              ],
            ),
          ),
        ],
